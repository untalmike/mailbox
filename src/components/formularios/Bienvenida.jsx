...
const Bienvenida = ({botones}) => {
    return (
        <div className={botones === 1 ? "hidden": ""}>
            <h1 className="text-2xl text-gray-800 py-4">Bienvenido al buzón de quejas y sugerencias</h1>
            <div className="text-xl italic font-semibold">
                ...
                <ul className="space-y-1 text-gray-500 list-disc list-inside text-lg mx-4">
